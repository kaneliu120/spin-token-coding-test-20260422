...
const socialLinks = [
  {
    label: 'Twitter',
    icon: <TwitterIcon />,
    href: 'https://twitter.com/spinbattles'
  },
  {
    label: 'Telegram',
    icon: <TelegramIcon />,
    href: 'https://t.me/spinbattles'
  },
  // {
  //   label: 'Discord',
  //   icon: <DiscordIcon />,
  ...
  // },
  {
    label: 'Facebook',
    icon: <FacebookIcon />,
    href: 'https://www.facebook.com/spinbattles'
  }
]
...
const Footer = () => {
  return (
    <Container sx={{mt: 5}}>
      ...
      >
        {'Copyright © '} {new Date().getFullYear()} SpinBattles. All rights reserved. 
      </Typography>
    </Container>
  );
}
