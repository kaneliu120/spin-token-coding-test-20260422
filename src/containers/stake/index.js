    ...
    <Fragment>
      <Container>
        <Box sx={{mb: 4}}>
          ...
          <Typography variant="body1" color="text.secondary">
            Stake $SPIN to earn more $SPIN. You can stake $SPIN tokens in the staking pools to earn high APR as a return for holding $SPIN tokens.
          </Typography>
        </Box>
      </Container>
      <Box 
      ...
      >
        <Container className="fadeInUp">
          ...
          >
            Stake $SPIN tokens to earn rewards
          </Typography>
          <Typography 
